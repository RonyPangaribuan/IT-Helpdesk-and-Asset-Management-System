<x-guest-layout>
    <div class="mb-6">
        <p class="text-sm font-medium text-indigo-700">Email verification</p>
        <h1 class="mt-1 text-2xl font-semibold tracking-tight text-slate-950">Verify your email</h1>
    </div>
